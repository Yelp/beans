...
def test_send_batch_meeting_confirmation_email(database):
    ...
    user_a = User(
        ...
        photo_url=('https://s3-media2.fl.yelpcdn.com/assets/srv0/yelp_large_assets/' +
    ...
    user_b = User(
        ...
        photo_url=('https://s3-media4.fl.yelpcdn.com/assets/srv0/yelp_large_assets/' +
    ...
    user_c = User(
        ...
        last_name='Yelp',
        email='darwin@yelp.com',
        photo_url=('https://s3-media1.fl.yelpcdn.com/assets/srv0/yelp_large_assets/' +
